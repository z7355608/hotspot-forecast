...
export function DashboardPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-[60vh] px-6 text-center">
      ...
      <p className="text-base text-gray-700 mb-2">数据看板</p>
      <p className="text-sm text-gray-400 mb-1">你的创作数据全景视图，预计 Q2 上线</p>
      <p className="text-xs text-gray-300 mb-8">多平台数据聚合 · 账号成长曲线 · 趋势对比</p>
      <button
        onClick={() => navigate('/')}
