...
const INDUSTRY_PATTERNS: Array<{ industry: string; topic: string; matcher: RegExp }> = [
  ...
  { industry: "AI/大模型", topic: "AI", matcher: /(AI|人工智能|大模型|chatgpt|gpt|prompt|aigc|llm|agent)/i },
  { industry: "编程开发", topic: "编程开发", matcher: /(编程|代码|开发|程序员|前端|后端|全栈|算法)/i },
  { industry: "科技数码", topic: "科技数码", matcher: /(科技|数码|手机|电脑|平板|耳机|相机|笔记本)/i },
